...
query_ids <- GET(
  ...
  query = list(db = "pubmed", term = "covid19 canada", retmax = 1000)
)
...
From the table above, we can see that 31 articles don't have an abstract.
...
From the table above, we can see that every article has a title.
