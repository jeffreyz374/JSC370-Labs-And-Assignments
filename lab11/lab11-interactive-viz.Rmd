...
- Read in and process the COVID dataset
...
The dataset consists of COVID-19 cases and deaths in each US state during the course of the COVID epidemic.
...
## I. Reading and processing the state-level COVID-19 data
